...
SOCIAL_MEDIA_ROOT = REPO_ROOT / "workspace" / "social-media"
AUTH_DIR = SOCIAL_MEDIA_ROOT / "auth"
POSTS_PUBLISHED = SOCIAL_MEDIA_ROOT / "posts" / "published"
POSTS_FAILED = SOCIAL_MEDIA_ROOT / "posts" / "failed"
